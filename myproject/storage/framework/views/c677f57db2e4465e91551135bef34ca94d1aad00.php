...
<table class="table"> 
    ...
    <?php $__currentLoopData = $arrays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baiviet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            <td><?php echo e($baiviet['name']); ?></td>
            <td><?php echo e($baiviet['desription']); ?></td>
...
<?php echo $__env->make('layouts.Menu_Footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\file bai tap\Php\myproject\resources\views/pages/Home/detail.blade.php ENDPATH**/ ?>