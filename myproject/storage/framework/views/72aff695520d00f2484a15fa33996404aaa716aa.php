...
<table class="table"> 
    ...
    <?php $__currentLoopData = $arrays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baiviet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
           <td> <a  href="<?php echo e(route('newspaper.detail',$baiviet['id'])); ?>"><?php echo e($baiviet['tieude']); ?></a></td>
            <td><?php echo e($baiviet['mota']); ?></td>
            <td><?php echo e($baiviet['noidung']); ?></td>
            <td><?php echo e($baiviet->chuyenMuc->tenchuyenmuc); ?></td>
...
<?php echo $__env->make('layouts.Menu_Footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Download\Documents\Document\myproject\resources\views/pages/Home/index.blade.php ENDPATH**/ ?>